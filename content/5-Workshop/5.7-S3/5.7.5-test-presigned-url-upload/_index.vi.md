...
*   **Kết quả thực tế**:
   ...
   ![Test 1: Yêu cầu không có JWT](/FCAJ-Workshop-voquockhanh/images/5-Workshop/5.7-S3/5.7.5-test-presigned-url-upload/TestURL1.png)
...
*   **Kết quả thực tế**:
   ...
   ![Test 2: Request có JWT hợp lệ](/FCAJ-Workshop-voquockhanh/images/5-Workshop/5.7-S3/5.7.5-test-presigned-url-upload/TestURL2.png)
...
*   **Kết quả thu được**: In ra log console `S3 upload status: 200` (thành công).
   ...
   ![Test 3: Log upload thành công](/FCAJ-Workshop-voquockhanh/images/5-Workshop/5.7-S3/5.7.5-test-presigned-url-upload/TestURL3.png)
...
*   **Bước 2**: Kiểm tra trực tiếp trên Amazon S3 Console:
   ...
   ![Kiểm tra tệp tin trên S3](/FCAJ-Workshop-voquockhanh/images/5-Workshop/5.7-S3/5.7.5-test-presigned-url-upload/TestURL4.png)
