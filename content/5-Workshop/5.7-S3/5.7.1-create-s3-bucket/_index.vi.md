...
1. Tạo S3 Bucket:
   ...
   * Cấu hình thông tin cơ bản:
   ...
   ![Tạo S3 Bucket](/FCAJ-Workshop-voquockhanh/images/5-Workshop/5.7-S3/5.7.1-create-s3-bucket/S3UpLoad6.2.png)
...
2. Cấu hình CORS Policy cho bucket vừa tạo:
   ...
   * Cuộn xuống mục **Cross-origin resource sharing (CORS)** -> Chọn **Edit**.
   ...
   ![Cấu hình CORS S3](/FCAJ-Workshop-voquockhanh/images/5-Workshop/5.7-S3/5.7.1-create-s3-bucket/S3UpLoad6.3.png)
   ...
   * Nhấn **Save changes** để hoàn tất.
   ...
   ![Lưu CORS S3 thành công](/FCAJ-Workshop-voquockhanh/images/5-Workshop/5.7-S3/5.7.1-create-s3-bucket/S3UpLoad6.4.png)
