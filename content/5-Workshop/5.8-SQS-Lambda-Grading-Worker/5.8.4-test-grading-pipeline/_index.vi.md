...
1. Chạy web local và làm bài thi:
   ...
   * Truy cập vào danh sách đề thi -> Chọn thi thử một đề bất kỳ -> Tiến hành chọn đáp án cho các câu hỏi.
   ...
   ![Sinh viên làm bài thi thử](/FCAJ-Workshop-voquockhanh/images/5-Workshop/5.8-SQS-Lambda-Grading-Worker/5.8.4-test-grading-pipeline/TestSQS1.png)
...
2. Nộp bài và đợi kết quả:
   ...
   * Do Backend API phản hồi `202 Accepted` và đưa bài thi vào hàng đợi SQS, Lambda Grading Worker sẽ xử lý bất đồng bộ trong nền và tự động trả về điểm số sau vài giây mà không cần sinh viên phải tải lại trang.
   ...
   ![Nộp bài thi thành công](/FCAJ-Workshop-voquockhanh/images/5-Workshop/5.8-SQS-Lambda-Grading-Worker/5.8.4-test-grading-pipeline/TestSQS2.png)

   ![Điểm số hiển thị sau khi chấm xong](/FCAJ-Workshop-voquockhanh/images/5-Workshop/5.8-SQS-Lambda-Grading-Worker/5.8.4-test-grading-pipeline/TestSQS3.png)
...
3. Kiểm tra nhật ký thực thi trên Amazon CloudWatch:
   ...
   * Kết quả cho thấy worker khởi chạy bình thường, nhận sự kiện từ SQS, giải mã payload và thực hiện chấm bài thành công.
   ...
   ![Nhật ký thực thi CloudWatch Logs](/FCAJ-Workshop-voquockhanh/images/5-Workshop/5.8-SQS-Lambda-Grading-Worker/5.8.4-test-grading-pipeline/TestSQS4.png)
