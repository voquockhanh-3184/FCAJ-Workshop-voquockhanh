...
1. Tạo HTTP API:
   ...
   * Cấu hình API:
   ...
   ![Cấu hình API](/FCAJ-Workshop-voquockhanh/images/5-Workshop/5.6-API-Gateway/5.6.1-create-http-api/API6.2.png)
...
2. Cấu hình Route cho backend Express:
   * Tạo các routes sau để ánh xạ request tới Lambda Backend:
   ...
   ![Cấu hình Route](/FCAJ-Workshop-voquockhanh/images/5-Workshop/5.6-API-Gateway/5.6.1-create-http-api/API6.3.png)
...
3. Cấu hình Stage và hoàn tất:
   ...
   * Bấm **Next** để kiểm tra lại cấu hình lần cuối (Review and create).
   ...
   ![Cấu hình Stage](/FCAJ-Workshop-voquockhanh/images/5-Workshop/5.6-API-Gateway/5.6.1-create-http-api/API6.4.png)

   * Nhấn **Create** và đợi thông báo tạo API thành công.

   ![Tạo thành công HTTP API](/FCAJ-Workshop-voquockhanh/images/5-Workshop/5.6-API-Gateway/5.6.1-create-http-api/API6.5.png)
