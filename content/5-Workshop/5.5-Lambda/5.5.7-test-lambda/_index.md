...
1. Create a Simulated Test Event:
   ...
   * Configure a new test event:
   ...
   ![Create Test Event](/FCAJ-Workshop-voquockhanh/images/5-Workshop/5.5-Lambda/5.5.6-deploy-backend/LambdaNen5.3.png)
...
2. Run the Test:
   ...
   * In the **Execution result** panel, verify the output response:
   ...
   ![Successful Test Execution](/FCAJ-Workshop-voquockhanh/images/5-Workshop/5.5-Lambda/5.5.6-deploy-backend/LambdaNen5.4.png)
...
3. Review Execution Logs in Amazon CloudWatch:
   ...
   * On the CloudWatch Logs page, open the latest **Log Stream** to inspect connection attempts to MongoDB Atlas, runtime bootstrap warnings, memory consumption metrics, and the unique AWS Request ID.
   ...
   ![Check CloudWatch Logs](/FCAJ-Workshop-voquockhanh/images/5-Workshop/5.5-Lambda/5.5.6-deploy-backend/CloudWatchLog.png)
