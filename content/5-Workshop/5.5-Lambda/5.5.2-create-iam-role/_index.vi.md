...
2. Cấu hình thực thể tin cậy (Trusted entity):
   ...
   * Bấm **Next**.
   ...
   ![Chọn Trusted Entity](/FCAJ-Workshop-voquockhanh/images/5-Workshop/5.5-Lambda/5.5.2-create-iam-role/LambdaBE5.2.png)
...
3. Gán các quyền cơ bản để ghi log và theo dõi trace: tại phần **Permissions policies**, tìm kiếm và tích chọn:
   ...
   * **AWSXRayDaemonWriteAccess**: Quyền cho phép Lambda gửi thông tin trace sang dịch vụ AWS X-Ray.
   ...
   ![Chọn Permission Policies](/FCAJ-Workshop-voquockhanh/images/5-Workshop/5.5-Lambda/5.5.2-create-iam-role/LambdaBE5.3.png)
...
4. Đặt tên và tạo Role:
   ...
   * Kiểm tra lại cấu hình và chọn **Create role**.
   ...
   ![Đặt tên Role](/FCAJ-Workshop-voquockhanh/images/5-Workshop/5.5-Lambda/5.5.2-create-iam-role/LambdaBE5.4.png)
...
5. Gán quyền đọc Secrets Manager cho Lambda (để kết nối tới MongoDB Atlas):
   ...
   * Đặt tên cho policy (ví dụ: `examora-lambda-secrets-policy`) -> Bấm **Create policy**.
   ...
   ![Gán Inline Policy](/FCAJ-Workshop-voquockhanh/images/5-Workshop/5.5-Lambda/5.5.2-create-iam-role/LambdaBE5.5.png)
