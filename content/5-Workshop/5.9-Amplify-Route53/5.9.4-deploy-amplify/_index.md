...
1. Deploy Frontend Bundle to AWS Amplify:
   ...
   * Under the *Start building with Amplify* section -> select **Deploy without Git** -> click **Next**.
   ...
   ![Select Deploy without Git](/FCAJ-Workshop-voquockhanh/images/5-Workshop/5.9-Amplify-Route53/5.9.4-deploy-amplify/Amplify1.png)
   ...
   * Click **Save and deploy** to trigger the manual deployment workflow.
   ...
   ![Upload ZIP and Deploy](/FCAJ-Workshop-voquockhanh/images/5-Workshop/5.9-Amplify-Route53/5.9.4-deploy-amplify/Amplify2.png)

   * Upon completion, AWS Amplify provisions a default domain with the following format: `https://main.xxxxxx.amplifyapp.com`.

   ![Deployment Succeeded](/FCAJ-Workshop-voquockhanh/images/5-Workshop/5.9-Amplify-Route53/5.9.4-deploy-amplify/Amplify3.png)

   * Click the generated URL link. If the Examora login screen renders correctly, the baseline deployment is successful.

   ![Access Login Page via Amplify Domain](/FCAJ-Workshop-voquockhanh/images/5-Workshop/5.9-Amplify-Route53/5.9.4-deploy-amplify/Amplify4.png)
...
2. Configure Single Page Application (SPA) Rewrites and Redirects:
   ...
   * From the Amplify application dashboard sidebar -> navigate to **Hosting** -> choose **Rewrites and redirects** -> click **Manage redirects**.
   ...
   ![Hosting Redirect Settings](/FCAJ-Workshop-voquockhanh/images/5-Workshop/5.9-Amplify-Route53/5.9.4-deploy-amplify/Amplify5.png)
   ...
   * Click **Save** to apply the rule. This prevents 404 response errors when users refresh application sub-routes.
   ...
   ![Configure Redirect Rules](/FCAJ-Workshop-voquockhanh/images/5-Workshop/5.9-Amplify-Route53/5.9.4-deploy-amplify/Amplify6.png)

   ![Save Redirect Rules](/FCAJ-Workshop-voquockhanh/images/5-Workshop/5.9-Amplify-Route53/5.9.4-deploy-amplify/Amplify7.png)
...
3. Update API Gateway CORS Configurations:
   ...
   * Under **Access-Control-Allow-Origin** -> add the default Amplify application domain URL -> click **Save**.
   ...
   ![CORS Settings in API Gateway](/FCAJ-Workshop-voquockhanh/images/5-Workshop/5.9-Amplify-Route53/5.9.4-deploy-amplify/CORS5.9.png)
...
4. Update Lambda Backend API Environment Variables:
   ...
   * Click **Save**.
   ...
   ![Update Lambda Environment Variables](/FCAJ-Workshop-voquockhanh/images/5-Workshop/5.9-Amplify-Route53/5.9.4-deploy-amplify/LambdaBE5.9.png)
...
5. Package, Redeploy, and Verify:
   ...
   * Navigate to the default Amplify application URL, log in as a student, and verify that all REST endpoints resolve correctly.
   ...
   ![E2E Application Testing](/FCAJ-Workshop-voquockhanh/images/5-Workshop/5.9-Amplify-Route53/5.9.4-deploy-amplify/TestAmplify1.png)
