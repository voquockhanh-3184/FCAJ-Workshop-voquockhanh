...
1. Initiate Custom Domain Mapping in AWS Amplify:
   ...
   * In the left sidebar -> under the **Hosting** section -> choose **Custom domains** -> click **Add domain**.
   ...
   ![Select Custom domains](/FCAJ-Workshop-voquockhanh/images/5-Workshop/5.9-Amplify-Route53/5.9.5-configure-domain/GanDomain1.png)

2. Select Domain and Configure Routing Rules:
   * Choose your custom domain name managed in Route 53 (e.g., `examora.click`).
   * Click **Configure domain**.

   ![Select domain managed by Route 53](/FCAJ-Workshop-voquockhanh/images/5-Workshop/5.9-Amplify-Route53/5.9.5-configure-domain/GanDomain2.png)
   ...
   * Click **Save** (or **Add domain**). AWS Amplify automatically initiates SSL/TLS certificate provisioning through AWS Certificate Manager (ACM) and updates the required CNAME and alias records in the corresponding Route 53 Hosted Zone.
   ...
   ![Configure Subdomain Mapping](/FCAJ-Workshop-voquockhanh/images/5-Workshop/5.9-Amplify-Route53/5.9.5-configure-domain/GanDomain3.png)
   ...
   * Await certificate validation and DNS mapping checks. Once the **Status** column displays a green **Available** flag, the custom domain setup is complete.
   ...
   ![Custom Domain Status Available](/FCAJ-Workshop-voquockhanh/images/5-Workshop/5.9-Amplify-Route53/5.9.5-configure-domain/GanDomain4.png)
...
3. Add Custom Domains to API Gateway CORS Allowed Origins:
   ...
   * Click **Save**.
   ...
   ![Add Custom Domains to CORS list](/FCAJ-Workshop-voquockhanh/images/5-Workshop/5.9-Amplify-Route53/5.9.5-configure-domain/GanDomain5.png)
...
4. Update Lambda Backend API Environment Variables:
   ...
   * Click **Save** to apply.
   ...
   ![Update Lambda Environment Variables](/FCAJ-Workshop-voquockhanh/images/5-Workshop/5.9-Amplify-Route53/5.9.5-configure-domain/GanDomain6.png)

5. End-to-End Production Verification:
   * Open a web browser and navigate to `https://www.examora.click` or `https://examora.click`.
   ![Verify website via Custom Domain](/FCAJ-Workshop-voquockhanh/images/5-Workshop/5.9-Amplify-Route53/5.9.5-configure-domain/GanDomain7.png)
