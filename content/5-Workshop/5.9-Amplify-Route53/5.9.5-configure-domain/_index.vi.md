...
1. Thiết lập Custom Domain trên Amplify app:
   ...
   * Tại thanh menu bên trái, phần **Hosting** -> Chọn mục **Custom domains** -> Chọn **Add domain**.
   ...
   ![Chọn Custom domains](/FCAJ-Workshop-voquockhanh/images/5-Workshop/5.9-Amplify-Route53/5.9.5-configure-domain/GanDomain1.png)

2. Chọn Domain và Cấu hình:
   * Chọn đúng domain đã cấu hình trong Route 53 từ trước (ví dụ: `examora.click`).
   * Bấm **Configure domain**.

   ![Chọn domain đã quản lý bởi Route 53](/FCAJ-Workshop-voquockhanh/images/5-Workshop/5.9-Amplify-Route53/5.9.5-configure-domain/GanDomain2.png)
   ...
   * Chọn **Save** (hoặc **Add domain**) và chờ đợi hệ thống thiết lập. Hệ thống sẽ tự động tạo chứng chỉ SSL/TLS miễn phí qua AWS Certificate Manager (ACM) và trỏ các bản ghi DNS cần thiết trong Route 53 cho bạn.
   ...
   ![Cấu hình Subdomain mapping](/FCAJ-Workshop-voquockhanh/images/5-Workshop/5.9-Amplify-Route53/5.9.5-configure-domain/GanDomain3.png)
   ...
   * Đợi quá trình xác thực SSL và cấu hình DNS hoàn tất. Khi thấy cột **Status** chuyển sang trạng thái màu xanh **Available**, tên miền tùy chỉnh đã được kích hoạt thành công.
   ...
   ![Tên miền tùy chỉnh sẵn sàng hoạt động](/FCAJ-Workshop-voquockhanh/images/5-Workshop/5.9-Amplify-Route53/5.9.5-configure-domain/GanDomain4.png)
...
3. Cập nhật CORS trong API Gateway cho Custom Domain:
   ...
   * Bấm **Save** để lưu lại.
   ...
   ![Bổ sung domain tùy chỉnh vào CORS](/FCAJ-Workshop-voquockhanh/images/5-Workshop/5.9-Amplify-Route53/5.9.5-configure-domain/GanDomain5.png)
...
4. Cập nhật biến môi trường cho Lambda Backend API:
   ...
   * Nhấn **Save** để lưu cấu hình.
   ...
   ![Cập nhật biến môi trường Lambda](/FCAJ-Workshop-voquockhanh/images/5-Workshop/5.9-Amplify-Route53/5.9.5-configure-domain/GanDomain6.png)

5. Truy cập kiểm tra thực tế:
   * Mở trình duyệt và truy cập các địa chỉ: `https://www.examora.click` hoặc `https://examora.click`.
   
   ![Truy cập website qua Custom Domain thành công](/FCAJ-Workshop-voquockhanh/images/5-Workshop/5.9-Amplify-Route53/5.9.5-configure-domain/GanDomain7.png)
